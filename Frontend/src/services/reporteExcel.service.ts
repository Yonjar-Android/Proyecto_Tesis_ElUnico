...
export const descargarReporteVentasServicioExcel = async (
    search: string = "",
    fechaInicio: string = "",
    fechaFin: string = "",
): Promise<Blob> => {
    const response = await axiosInstance.get(`${API}/excel/servicios-por-periodo`, {
        params: { 
            search, 
            fechaInicio, 
            fechaFin ,
...
export const descargarReporteVentasProductoExcel = async (
     search: string = "",
     fechaInicio: string = "",
     fechaFin: string = ""
 ): Promise<Blob> => {
     const response = await axiosInstance.get(`${API}/excel/productos-por-periodo`, {
