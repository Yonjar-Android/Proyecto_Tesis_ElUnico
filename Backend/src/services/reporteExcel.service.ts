...
export const generateReporteInventarioExcel = async (
    search: string = "",
    ...
    return await generateInventarioExcelReport(reportData);
}

export const generateReporteDevolucionesExcel = async (
    search: string = "",
    fechaInicio: string = "",
    fechaFin: string = ""
): Promise<ExcelJS.Buffer> => {
